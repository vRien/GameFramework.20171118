...
void PlayState::update()
{
	...
	if (checkCollision(
		dynamic_cast<SDLGameObject*>(m_SDLGameObjects[0]),
		dynamic_cast<SDLGameObject*>(m_SDLGameObjects[1])))
	{
...
bool PlayState::onEnter()
{
	...
	m_SDLGameObjects.push_back(player);
	m_SDLGameObjects.push_back(enemy);
